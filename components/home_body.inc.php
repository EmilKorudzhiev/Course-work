...
<div class="p-5">
          <button type="button" class="btn btn-light"><a href="../controllers/register.php">REGISTER NOW</a></button>
          <button type="button" class="btn btn-light"><a href="../controllers/login.php">LOG IN NOW</a></button>
        </div>
